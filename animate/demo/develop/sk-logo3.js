(function () {
  ...
  /*  Movie.traRightT = An.createMovieClip({
   ...
   An.graphic.shape([0,0,200,20,0,40], Movie.baseColor, true, true);
    ...
    An.resource.loadImage({
        sk: '/animate/demo/images/skr.png',
  ...
  Movie.part0 = An.createClip({
      x: Movie.centerPoint.x - 148,
      y: Movie.centerPoint.y - 148
  }, function (ctx, i) {
      this.x -= Math.sin(i / 13.8) * 3.2;
      this.y += Math.cos(i / 5.8) * 4.2;
    ctx.drawImage(Movie.images.part0, this.x, this.y);
  });

  Movie.part1 = An.createClip({
    x: Movie.centerPoint.x + 28,
    y: Movie.centerPoint.y - 93,
  }, function (ctx, i) {
    this.x -= Math.sin(i / 4.8) * 2.2;
    this.y += Math.cos(i / 8.8) * 1.2;
    ctx.drawImage(Movie.images.part1, this.x, this.y);
  });

  Movie.part2 = An.createClip({
    x: Movie.centerPoint.x,
    y: Movie.centerPoint.y + 28,
  }, function (ctx, i) {
    this.x -= Math.sin(i / 6.8) * 2.2;
    this.y += Math.cos(i / 3.8) * 3.2;
    ctx.drawImage(Movie.images.part2, this.x, this.y);
  });

  Movie.part3 = An.createClip({
    x: Movie.centerPoint.x - 103,
    y: Movie.centerPoint.y + 28,
  }, function (ctx, i) {
    this.x -= Math.sin(i / 8.8) * 4.2;
    this.y += Math.cos(i / 5.8) * 3.2;
    ctx.drawImage(Movie.images.part3, this.x, this.y);
  });

  Movie.part4 = An.createClip({
    x: Movie.centerPoint.x - 146,
    y: Movie.centerPoint.y + 7,
  }, function (ctx, i) {
    this.x -= Math.sin(i / 6.8) * 3.2;
    this.y += Math.cos(i / 8.8) * 4.2;
    ...
    An.frame(function (ctx, i) {
      ...
      // ctx.drawImage(Movie.images.sk, 0, 0);
        ...
        if (Movie.currentScene === Movie.scene.boom) {
          ...
          // ctx.drawImage(
          //   Movie.images.part0,
          //   Movie.centerPoint.x - 147, Movie.centerPoint.y - 124);
          //
          // ctx.drawImage(
          //   Movie.images.part1,
          //   Movie.centerPoint.x + 28, Movie.centerPoint.y - 69);
          //
          // ctx.drawImage(
          //   Movie.images.part2,
          //   Movie.centerPoint.x, Movie.centerPoint.y + 52);
          //
          // ctx.drawImage(
          //   Movie.images.part3,
          //   Movie.centerPoint.x - 103, Movie.centerPoint.y + 52);
          //
          // ctx.drawImage(
          //   Movie.images.part4,
          //   Movie.centerPoint.x - 146, Movie.centerPoint.y + 31);
